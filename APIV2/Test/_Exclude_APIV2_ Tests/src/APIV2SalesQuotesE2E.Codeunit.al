codeunit 139823 "APIV2 - Sales Quotes E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL('', Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt);
    ...
    begin
        ...
        // [GIVEN] a JSON text with a quote that contains the customer and an address
        QuoteJSON := CreateQuoteJSONWithAddress(SellToCustomer, BillToCustomer, ShipToCustomer, QuoteDate);
        Commit();
    ...
    begin
        ...
        // [GIVEN] a JSON text with an quote that has the addresses
        LibraryGraphDocumentTools.GetCustomerAddressJSON(QuoteJSON, SellToCustomer, 'sellTo', EmptyData, PartiallyEmptyData);
        LibraryGraphDocumentTools.GetCustomerAddressJSON(QuoteJSON, ShipToCustomer, 'shipTo', EmptyData, PartiallyEmptyData);
        LibraryGraphDocumentTools.GetCustomerAddressJSON(QuoteJSON, BillToCustomer, 'billTo', EmptyData, PartiallyEmptyData);

        Commit();

        // [WHEN] we PATCH the JSON to the web service, with the unique quote ID
        TargetURL := LibraryGraphMgt.CreateTargetURL(QuoteIntegrationID, Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt);
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(ID[1], Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt);
        LibraryGraphMgt.DeleteFromWebService(TargetURL, '', ResponseText);
        TargetURL := LibraryGraphMgt.CreateTargetURL(ID[2], Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt);
        LibraryGraphMgt.DeleteFromWebService(TargetURL, '', ResponseText);
    ...
    begin
        ...
        QuoteJSON := CreateQuoteJSONWithAddress(Customer, Customer, Customer, QuoteDate);
        Commit();
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(SalesHeader.SystemId, Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt);
        LibraryGraphMgt.GetFromWebService(ResponseText, TargetURL);
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(DocumentId, Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt, ActionSendTxt);
    ...
    begin
        ...
        // [WHEN] A POST request is made to the API.
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(DocumentId, Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt, ActionMakeInvoiceTxt);
        LibraryGraphMgt.PostToWebServiceAndCheckResponseCode(TargetURL, '', ResponseText, 204);
    ...
    begin
        ...
        // [WHEN] A POST request is made to the API.
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(DocumentId, Page::"APIV2 - Sales Quotes", QuoteServiceNameTxt, ActionMakeOrderTxt);
        LibraryGraphMgt.PostToWebServiceAndCheckResponseCode(TargetURL, '', ResponseText, 204);
    ...
    begin
        ...
        LibraryGraphDocumentTools.GetCustomerAddressJSON(QuoteJSON, SellToCustomer, 'sellTo', false, false);
        LibraryGraphDocumentTools.GetCustomerAddressJSON(QuoteJSON, BillToCustomer, 'billTo', false, false);
        LibraryGraphDocumentTools.GetCustomerAddressJSON(QuoteJSON, ShipToCustomer, 'shipTo', false, false);
        exit(QuoteJSON);
    end;
