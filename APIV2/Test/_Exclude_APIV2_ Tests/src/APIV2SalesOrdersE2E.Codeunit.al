codeunit 139811 "APIV2 - Sales Orders E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL('', Page::"APIV2 - Sales Orders", OrderServiceNameTxt);
    ...
    begin
        ...
        // [GIVEN] a JSON text with an order that contains the customer and an address
        OrderJSON := CreateOrderJSONWithAddress(SellToCustomer, BillToCustomer, ShipToCustomer, OrderDate, PostingDate);
        Commit();
    ...
    begin
        ...
        LibraryGraphDocumentTools.GetCustomerAddressJSON(OrderJSON, SellToCustomer, 'sellTo', EmptyData, PartiallyEmptyData);
        LibraryGraphDocumentTools.GetCustomerAddressJSON(OrderJSON, ShipToCustomer, 'shipTo', EmptyData, PartiallyEmptyData);

        Commit();

        // [WHEN] we PATCH the JSON to the web service, with the unique order ID
        TargetURL := LibraryGraphMgt.CreateTargetURL(OrderId, Page::"APIV2 - Sales Orders", OrderServiceNameTxt);
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(OrderId[1], Page::"APIV2 - Sales Orders", OrderServiceNameTxt);
        LibraryGraphMgt.DeleteFromWebService(TargetURL, '', ResponseText);
        TargetURL := LibraryGraphMgt.CreateTargetURL(OrderId[2], Page::"APIV2 - Sales Orders", OrderServiceNameTxt);
        LibraryGraphMgt.DeleteFromWebService(TargetURL, '', ResponseText);
    ...
    begin
        ...
        OrderJSON := CreateOrderJSONWithAddress(Customer, Customer, Customer, DocumentDate, PostingDate);
        Commit();
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(SalesHeader.SystemId, Page::"APIV2 - Sales Orders", OrderServiceNameTxt);
        LibraryGraphMgt.GetFromWebService(ResponseText, TargetURL);
    ...
    begin
        ...
        TargetURL :=
          LibraryGraphMgt.CreateTargetURLWithSubpage(OrderId, Page::"APIV2 - Sales Orders", OrderServiceNameTxt, ActionShipAndInvoiceTxt);
    ...
    begin
        ...
        LibraryGraphDocumentTools.GetCustomerAddressJSON(OrderJSON, SellToCustomer, 'sellTo', false, false);
        LibraryGraphDocumentTools.GetCustomerAddressJSON(OrderJSON, ShipToCustomer, 'shipTo', false, false);
