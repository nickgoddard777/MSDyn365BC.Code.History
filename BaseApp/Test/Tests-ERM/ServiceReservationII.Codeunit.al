codeunit 136143 "Service Reservation II"
{
    ...
    var
        ...
        ModifyFieldError: Label '%1 must be equal to ''0''  in %2: %3=%4, %5=%6, %7=%8. Current value is ''%9''.', Comment = 'Field Caption,Table Caption,Document Type Field Caption,Document Type Field Value,Document No. Field Caption,Document No. Field Value,Line No. Field Caption,Line No. Field Value,Quantity Field Value';
