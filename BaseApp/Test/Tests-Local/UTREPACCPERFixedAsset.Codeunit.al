codeunit 144027 "UT REP ACCPER - Fixed Asset"
{
    ...
    var
        ...
        GroupHeadLineCap: Label 'GroupHeadLine';
        GroupTotalsCap: Label 'Group Totals';
        MainAssetCap: Label 'Main Asset';
        DepreciationCap: Label 'Depreciation';
        Custom1TextCap: Label 'Custom1Text';
        DeprCustom1TextCap: Label 'DeprCustom1Text';
    ...
    local procedure SetValuesOnFAProjectedValueRequestPage(var FAProjectedValue: TestRequestPage "FA - Projected Value")
    var
        No: Variant;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure FAProjectedValueWithInsertBalAccReqPageHandler(var FAProjectedValue: TestRequestPage "FA - Projected Value")
    begin
        SetValuesOnFAProjectedValueRequestPage(FAProjectedValue);
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure FAProjectedValueWithPrintperFAReqPageHandler(var FAProjectedValue: TestRequestPage "FA - Projected Value")
    begin
        SetValuesOnFAProjectedValueRequestPage(FAProjectedValue);
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure FAProjectedValWithProjectedDisposalReqPageHandler(var FAProjectedValue: TestRequestPage "FA - Projected Value")
    var
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure FAProjectedValueWithNumberOfDaysReqPageHandler(var FAProjectedValue: TestRequestPage "FA - Projected Value")
    begin
        SetValuesOnFAProjectedValueRequestPage(FAProjectedValue);
