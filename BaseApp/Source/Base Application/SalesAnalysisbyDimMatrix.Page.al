page 9227 "Sales Analysis by Dim Matrix"
{
    ...
    procedure LoadVariables(ItemAnalysisView1: Record "Item Analysis View"; CurrentItemAnalysisViewCode1: Code[10]; CurrentAnalysisArea1: Option Sales,Purchase,Inventory; LineDimOption1: Option Item,Period,Location,"Dimension 1","Dimension 2","Dimension 3"; ColumnDimOption1: Option Item,Period,Location,"Dimension 1","Dimension 2","Dimension 3"; PeriodType1: Enum "Analysis Period Type"; ValueType1: Option "Sales Amount","COGS Amount","Sales Quantity"; RoundingFactor1: Option "None","1","1000","1000000"; ShowActualBudget1: Option "Actual Amounts","Budgeted Amounts",Variance,"Variance%","Index%"; MatrixColumnCaptions1: array[32] of Text[1024]; ShowOppositeSign1: Boolean; PeriodInitialized1: Boolean; ShowColumnName1: Boolean; NoOfRecordsLocal: Integer)
    begin
        LoadMatrix(
            ItemAnalysisView1, CurrentItemAnalysisViewCode1,
            "Analysis Area Type".FromInteger(CurrentAnalysisArea1),
            "Item Analysis Dimension Type".FromInteger(LineDimOption1),
            "Item Analysis Dimension Type".FromInteger(ColumnDimOption1),
            PeriodType1, "Item Analysis Value Type".FromInteger(ValueType1),
            "Analysis Rounding Factor".FromInteger(RoundingFactor1),
            "Item Analysis Show Type".FromInteger(ShowActualBudget1),
